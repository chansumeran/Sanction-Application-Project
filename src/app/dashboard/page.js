      ...
      >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-4 items-center">
            ...
            <div
              id="advanceButton"
              className="inset-0 flex items-center justify-center relative  text-left bg-primary rounded-lg"
            >
              <motion.button
                whileHover={{
                  scale: 1.05,
        ...
        <div className="relative overflow-x-auto mt-10" id="table">
          {students.length === 0 ? (
            ...
            <table
              id="sanction-list"
              className="w-full text-sm text-left rtl:text-right text-secondary  "
            >
              ...
              <tbody>
                {students.map((student) => (
                  <tr
                    ...
                    className="bg-white border-b text-gray-700 text-center font-semibold"
                  >
                        ...
                        <div>
                          ...
                          <Dropdown>
                            ...
                            >
                              ...
                              <DropdownItem
                                key="Intramurals 2024"
                                className="hover:bg-gray-200 rounded-lg"
                              >
                                Intramurals 2024
                              </DropdownItem>
                              <DropdownItem
                                key="Foundation Week 2024"
                                className="hover:bg-gray-200 rounded-lg"
                              >
